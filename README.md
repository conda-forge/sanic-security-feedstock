...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sanic-security-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13047&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sanic-security-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sanic-security` can be installed with:

```
conda install sanic-security
```

It is possible to list all of the versions of `sanic-security` available on your platform with:
